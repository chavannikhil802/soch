                ...
                <div class="each-event">
                    <div class="event-description" id="odd1">
                       ...
                       <p>
                            ...
                            project management team, content writers, Digital Marketing team, server administrators and support team, we are equipped to deliver services par excellence.
                        </p>
                    </div>
                </div>
                <div class="each-event">
                    <div class="event-description">
                        ...
                        <p>
                            ...
                            Video designing, Internet marketing and many more. We have delivered customized websites for diverse industries and have 
                            completed many applications projects for our clients across the world.
                        </p>
                    </div>
                </div>
                <div class="each-event">
                ...
                <div class="each-event">
                    <div class="event-description">
                       ...
                       <p>
                            ...
                            places and different time zones. An efficient project development life cycle coupled with systematic project execution 
                            techniques ensures smooth working. Well defined processes ensure effective communication with the clients.
                        </p>
                    </div>
                </div>
                <div class="each-event">
                    <div class="event-description">
                       ...
                       <p>
                            ...
                            Customer Support Team would handle maintenance queries / issues. The support team would handle any change request or renewals or upgrades.
                        </p> 
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col50">
                    <div class="contactForm">
                        ...
                        <div class="inputBox">
                            <input type="text" id="subject" placeholder="E-Mail Subject" required>
                        </div>
                        <div class="inputBox">
                            <input type="text" id="contact-no" placeholder="Contact Number" required>
                        </div>
                        <div class="inputBox">
                            <textarea  id="message" placeholder="Enter You Message here" required></textarea>
                        </div>
                        <div class="inputBox">
                ...
                <div class="col50">
                    <div class="address">
                        ...
                        <p>
                            3rd Floor 305, Atharva Feryez Plaza,
                            <br/>
